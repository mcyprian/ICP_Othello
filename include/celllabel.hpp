...
/** Customized QLabel, containing mouse interaction and position settings of grid cell. */
...
signals:
    ...
    void cellMoved(int x, int y); /** Signal to indicate mouse move on the cell. */
    void cellLeft(int x, int y); /** Signal to indicate that mouse left the cell. */
