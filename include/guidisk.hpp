...
class GUIDisk : public QObject, public QGraphicsPixmapItem {
 ...
 public:
  /** Constructor loads pictures from resources, sets up position according to
   * arguments.
 ...
 private:
  QPixmap colors_pix[2]; /** Array storing regular pictures of black and white
                            disk. */
  QPixmap transparent_pix[2]; /** Array storing transparent versions of disks
                                 images. */
